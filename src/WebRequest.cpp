...
AsyncWebServerRequest::AsyncWebServerRequest(AsyncWebServer* s, AsyncClient* c)
  ...
  , _contentLength(0)
  , _parsedLength(0)
  , _headers(LinkedListNew<AsyncWebHeader *>([](AsyncWebHeader *h){ delete h; }))
  , _params(LinkedListNew<AsyncWebParameter *>([](AsyncWebParameter *p){ delete p; }))
  , _pathParams(LinkedListNew<String *>([](String *p){ delete p; }))
  , _multiParseState(0)
  , _boundaryPosition(0)
  , _itemStartIndex(0)
  , _itemSize(0)
